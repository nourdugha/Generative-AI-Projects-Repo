...
from src.rag_app.get_embedding_function import get_embeddings
...
DATA_SOURCES_PATH = "src/data_source"
...
def load_documents():
    document_loader = PyPDFDirectoryLoader(DATA_SOURCES_PATH)
...
def add_to_chroma(chunks: list[Document]):
    ...
    chunks_with_ids = calculate_chunks_id(chunks)
    for chunk in chunks:
    ...
    print(f"Number of existing documents in DB is {len(existing_items)}")
